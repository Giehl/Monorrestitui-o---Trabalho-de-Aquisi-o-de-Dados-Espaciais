...
'''Pontos de verificação: 2,94,123,129,133,138'''
# Pontos de verificação na imagem-CL (2,94,123,129,133,138)--------------------
...
# Pontos de verificação no terreno (Nome do Ponto, XYZ (02,94,123,129,133,138))
...
while not stop:
    ...
    #Matriz A------------------------------------------------------------------
    A=matrizA(pa_pc,xp,yp,X0).astype(np.float)       
    At = np.transpose(A)
    part1 = np.dot(At, P);  
